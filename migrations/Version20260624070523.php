...
final class Version20260624070523 extends AbstractMigration
{
    ...
    {
        return 'Add SEO columns on ContentEntry + new entities: SeoRevision, Redirect, RedirectRevision, NotFoundLog, Form, FormSubmission';
    }

    public function up(Schema $schema): void
    {
        // SEO columns on ContentEntry
        $this->addSql('ALTER TABLE content_entry ADD meta_title VARCHAR(255) DEFAULT NULL, ADD meta_description LONGTEXT DEFAULT NULL, ADD slug VARCHAR(255) NOT NULL, ADD canonical_url VARCHAR(512) DEFAULT NULL, ADD og_image VARCHAR(36) DEFAULT NULL, ADD seo_score INT DEFAULT NULL, ADD seo_scored_at DATETIME DEFAULT NULL');
        ...
        // NotFoundLog
        $this->addSql('CREATE TABLE not_found_log (id INT AUTO_INCREMENT NOT NULL, project_id INT NOT NULL, path VARCHAR(512) NOT NULL, referrer VARCHAR(512) DEFAULT NULL, user_agent VARCHAR(512) DEFAULT NULL, ip VARCHAR(45) DEFAULT NULL, count INT NOT NULL, first_seen_at DATETIME NOT NULL, last_seen_at DATETIME NOT NULL, is_resolved TINYINT(1) NOT NULL, INDEX IDX_82FD3B90166D1F9C (project_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE not_found_log ADD CONSTRAINT FK_82FD3B90166D1F9C FOREIGN KEY (project_id) REFERENCES project (id)');

        // Form
        $this->addSql('CREATE TABLE form (id INT AUTO_INCREMENT NOT NULL, uuid BINARY(16) NOT NULL, project_id INT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, title VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, fields JSON NOT NULL, steps JSON DEFAULT NULL, settings JSON NOT NULL, is_published TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_5288FD4FD17F50A6 (uuid), INDEX IDX_5288FD4F166D1F9C (project_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE form ADD CONSTRAINT FK_5288FD4F166D1F9C FOREIGN KEY (project_id) REFERENCES project (id)');

        // FormSubmission
        $this->addSql('CREATE TABLE form_submission (id INT AUTO_INCREMENT NOT NULL, uuid BINARY(16) NOT NULL, form_id INT NOT NULL, data JSON NOT NULL, metadata JSON NOT NULL, step INT DEFAULT NULL, is_complete TINYINT(1) NOT NULL, is_spam TINYINT(1) NOT NULL, is_read TINYINT(1) NOT NULL, ab_variant VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, read_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_D2C21667D17F50A6 (uuid), INDEX IDX_D2C216675FF69B7D (form_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE not_found_log DROP FOREIGN KEY FK_82FD3B90166D1F9C');
